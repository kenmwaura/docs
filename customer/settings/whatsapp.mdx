...
The default whatsapp tokens expire after a few hours as they are normally used for testing. You need to create a permanent token instead if you don't want this.
