...
<Warning>
    The tutorial describes using a temporary access token which lasts for only 24 hours and has to be renewed. In order to avoid this hassle, you should setup a
